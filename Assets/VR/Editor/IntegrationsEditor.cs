...
namespace VR {
    ...
    public class IntegrationsEditor : EditorWindow {
        ...
        [MenuItem("XR Simulation Framework/Plugins Integrations")]
        ...
        void OnGUI() {
            ...
            VRIntegrationsSettings.OculusIntegration = EditorGUILayout.Toggle("Oculus Integration", VRIntegrationsSettings.OculusIntegration);
            //VRIntegrationsSettings.SteamVRIntegration = EditorGUILayout.Toggle("SteamVR Integration", VRIntegrationsSettings.SteamVRIntegration);
            //VRIFSettiVRIntegrationsSettingsngs.PicoIntegration = EditorGUILayout.Toggle("Pico Integration", VRIntegrationsSettings.PicoIntegration);
    ...
    public class VRIntegrationsSettings {
