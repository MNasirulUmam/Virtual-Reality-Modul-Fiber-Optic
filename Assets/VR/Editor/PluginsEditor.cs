...
public class PluginsEditor : EditorWindow {
    ...
    [MenuItem("XR Simulation Framework/Plugins Helper")]
    ...
    void OnGUI() {
        ...
        GUILayout.Label("\n<b>Welcome to the XR Simulation Framework! Please be advised this simulation framework only support Oculus Quest 2</b> \nBelow is a list of XR-related packages and their current installation status. \n",  rt);
        ...
        if(ShowedFirstRunWindow) {
            EditorGUILayout.HelpBox("This appears to be your fist time installing XR Simulation Framework - awesome!", MessageType.Info);
        ...
        AddLink("UNUSA Virtual Reality Lab.", "https://vr.unusa.ac.id");
        AddLink("PENS Human Centric Multimedia Lab.", "http://dhoto.pens.ac.id");
        AddLink("More VR Demos...", "www.ilhamachmada.com/demo");
