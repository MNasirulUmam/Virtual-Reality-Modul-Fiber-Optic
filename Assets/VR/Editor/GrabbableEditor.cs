...
namespace VR {
    ...
    public class GrabbableEditor : Editor {
        ...
        [MenuItem("GameObject/XR Simulation Framework/Grab Function/Grabbable", false, 10)]
        ...
        [MenuItem("GameObject/XR Simulation Framework/EventSystem", false, 20)]
        private static void AddEventSystem(MenuCommand menuCommand) {
            // Create and add a new Grabbable Object in the Scene
            GameObject eventSystem = Instantiate(Resources.Load("EventSystem", typeof(GameObject))) as GameObject;
